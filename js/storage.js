...
const DB_VERSION = 1;
export const DEFAULT_SETTINGS = { schemaVersion: DATA_SCHEMA_VERSION, voice: '', speed: 1, captions: true, autoPlay: true, hintMode: false, practiceMode: 'free', selectedAvatar: 'aiko' };
let dbPromise;
